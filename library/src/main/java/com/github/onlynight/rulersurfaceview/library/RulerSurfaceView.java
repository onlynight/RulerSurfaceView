...
public class RulerSurfaceView extends SurfaceView implements
    ...
    private void initPaint() {
        ...
        } else if (lineType == LINE_TYPE_LINE) {
            // do nothing
        }
    ...
    private void drawRuler(Canvas canvas) {
        if (rulerCalculator != null) {
            rulerCalculator.calculate(RulerCalculator.point2PointO(measureBtn1Pos),
                    RulerCalculator.point2PointO(measureBtn2Pos));
            //画标尺
            List<Point> points = RulerCalculator.pointfs2Points(
                    rulerCalculator.getRulerLinePoints());
            ...
            //画尺子边框
            List<Point> rulerPoints = RulerCalculator.pointfs2Points(rulerCalculator.getRulerPoints());
            ...
            //画尺子刻度
            List<Point> bottomScalePoints = RulerCalculator.pointfs2Points(rulerCalculator.getRulerBottomScalePoints());
            List<Point> top1ScalePoints = RulerCalculator.pointfs2Points(rulerCalculator.getRulerTop1ScalePoints());
            List<Point> top2ScalePoints = RulerCalculator.pointfs2Points(rulerCalculator.getRulerTop2ScalePoints());
            List<Point> operatorPoints = RulerCalculator.pointfs2Points(rulerCalculator.getOperatorPoints());
            //画尺子小刻度
